...
const char *si_gameTypeArgs[]		= { "singleplayer", "DM", "Tourney", "Team DM", "CTF", "Arena CTF", "Domination", NULL };
// RAVEN END
...
// server info
idCVar si_name(						"si_name",					"Domination Server",	CVAR_GAME | CVAR_SERVERINFO | PC_CVAR_ARCHIVE, "name of the server" );
// RAVEN BEGIN
// ddynerman: new gametype strings
idCVar si_gameType(					"si_gameType",				si_gameTypeArgs[ 6 ],	CVAR_GAME | CVAR_SERVERINFO | PC_CVAR_ARCHIVE, "game type - singleplayer, DM, Team DM, CTF, Arena CTF, Tourney, or Domination", si_gameTypeArgs, idCmdSystem::ArgCompletion_String<si_gameTypeArgs> );
...
idCVar si_dominationLimit(			"si_dominationLimit",		"300",			CVAR_GAME | CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_INTEGER, "Domination limit", 0, MP_PLAYER_MAXFRAGS );
